...
Notification.new("<Color=Cyan>Welcome to Poison Hub<Color=/>"):Display()
wait(0.5)
...
I:Label("Script Created By Xeter Hub")
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Poison Hub";
    Text = "Loading Done!";
    Icon = "rbxthumb://type=Asset&id=112696253172872&w=150&h=150";
    Duration = 10
})
